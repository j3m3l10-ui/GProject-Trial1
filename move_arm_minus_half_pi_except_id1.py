...
# Set target angles: all -pi/2 except gripper (ID 1) = 0
angles = np.array([-np.pi/2, -np.pi/2, -np.pi/2, -np.pi/2, 0], dtype=float)
# Convert to pulses
...
print("[POSE] Moving all servos to -pi/2 (except ID 1 = 0) and holding...")
